...
INSERT INTO criatura (nombre, unicode, terreno, coste, vida, ataque, floop_id)
VALUES ('Husker Knight', '🌽', 'MAIZ', 1, 3, 6, currval('floop_id_seq'));
...
INSERT INTO criatura (nombre, unicode, terreno, coste, vida, ataque, floop_id)
VALUES ('Earl', '🌈', 'ARCOIRIS', 3, 5, 10, currval('floop_id_seq'));
...
INSERT INTO criatura (nombre, unicode, terreno, coste, vida, ataque, floop_id)
VALUES ('Fummy', '🏜️', 'DESIERTO', 4, 24, 10, currval('floop_id_seq'));
...
INSERT INTO criatura (nombre, unicode, terreno, coste, vida, ataque, floop_id)
VALUES ('Field Reaper', '☠️', 'MAIZ', 4, 13, 25, currval('floop_id_seq'));
...
INSERT INTO criatura (nombre, unicode, terreno, coste, vida, ataque, floop_id)
VALUES ('Hot Eyebat', '🔥', 'PANTANO', 2, 9, 8, currval('floop_id_seq'));
...
INSERT INTO criatura (nombre, unicode, terreno, coste, vida, ataque, floop_id)
VALUES ('Banshe Princess', '👑', 'PANTANO', 1, 2, 7, currval('floop_id_seq'));
...
INSERT INTO criatura (nombre, unicode, terreno, coste, vida, ataque, floop_id)
VALUES ('Bog Bum', '🟢', 'PANTANO', 2, 10, 8, currval('floop_id_seq'));
...
INSERT INTO criatura (nombre, unicode, terreno, coste, vida, ataque, floop_id)
VALUES ('Gray Eyebat', '👁️', 'PANTANO', 1, 5, 2, currval('floop_id_seq'));
...
INSERT INTO criatura (nombre, unicode, terreno, coste, vida, ataque, floop_id)
VALUES ('Herculeye', '💪', 'PANTANO', 2, 9, 11, currval('floop_id_seq'));
...
INSERT INTO criatura (nombre, unicode, terreno, coste, vida, ataque, floop_id)
VALUES ('Bog BanShe Angel', '🪽', 'PANTANO', 4, 15, 24, currval('floop_id_seq'));
...
INSERT INTO criatura (nombre, unicode, terreno, coste, vida, ataque, floop_id)
VALUES ('Nicelands Eye Bat', '✨', 'LLANURA', 2, 10, 7, currval('floop_id_seq'));
...
INSERT INTO criatura (nombre, unicode, terreno, coste, vida, ataque, floop_id)
VALUES ('Chest Burster', '💥', 'PANTANO', 4, 8, 5, currval('floop_id_seq'));
...
INSERT INTO criatura (nombre, unicode, terreno, coste, vida, ataque, floop_id)
VALUES ('Log Knight', '🪵', 'MAIZ', 0, 20, 10, currval('floop_id_seq'));
...
INSERT INTO criatura (nombre, unicode, terreno, coste, vida, ataque, floop_id)
VALUES ('Bald Man''s Throne', '🚽', 'PANTANO', 0, 15, 15, currval('floop_id_seq'));
...
INSERT INTO criatura (nombre, unicode, terreno, coste, vida, ataque, floop_id)
VALUES ('Fatapillar', '💚', 'LLANURA', 0, 27, 3, currval('floop_id_seq'));
...
INSERT INTO criatura (nombre, unicode, terreno, coste, vida, ataque, floop_id)
VALUES ('Green Party Ogre', '🛡️', 'DESIERTO', 0, 19, 11, currval('floop_id_seq'));
